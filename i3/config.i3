...
# └── ─ ─
workspace $PWS1_TRM output {{ output_primary }}
workspace $PWS3_WWW output {{ output_primary }}
workspace $PWS2_DEV output {{ output_primary }}

workspace $SWS1_AUX output {{ output_secondary }}
workspace $SWS3_DBG output {{ output_secondary }}
workspace $SWS2_COM output {{ output_secondary }}
...
assign [name="general | clojurians Slack - Vimperator"] $SWS2_COM
...
client.focused {{ dark_blue }} {{ dark_blue }} {{ black }} {{ dark_cyan }}
client.focused_inactive {{ background1 }} {{ background0 }} {{ foreground }} {{ background0_s }}
client.unfocused {{ dark_blue }}   {{ background1 }} {{ dark_gray }}  {{ dark_cyan }}
client.urgent {{ dark_orange }} {{ dark_orange }} {{ background }} {{ dark_orange }}
client.placeholder {{ cyan }} {{ dark_cyan }} {{ black }} {{ magenta }}

{% if target == "lintilla" %}
{% include 'bar/lintilla/bar_primary.j2' %}
{% include 'bar/lintilla/bar_secondary.j2' %}
{% include 'bar/lintilla/bar_tertiary.j2' %}
{% endif %}

{% if target == "allitnil" %}
{% include 'bar/allitnil/bar_primary.j2' %}
{% include 'bar/allitnil/bar_secondary.j2' %}
{% endif %}
