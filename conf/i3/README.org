...
*** Colors and variables
    ...
    splitting up my i3 into a [[file:../../templates/i3/config.i3][template]], [[file:../../templates/i3/variables.i3][variables]] and [[https://github.com/roosta/etc/tree/master/local][local variables]].
