...
alias viterm="${EDITOR:-vim} ~/etc/conf/alacritty/.config/alacritty/alacritty.toml"
...
alias viway="${EDITOR:-vim} ~/etc/conf/waybar/.config/waybar/config.jsonc ~/etc/conf/waybar/.config/waybar/style.css"
